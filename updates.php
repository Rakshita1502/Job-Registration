              ...
              <div class="row register-form">
                ...
                <?php
                  ...
                  if(isset($_POST['submit'])){
                    ...
                    $updatequery="update jobregistration set id=$idupdate,name='$username',degree='$degree',mobile='$mobile',email='$email',refer='$refer',jobpost='$jobprofile' where id=$idupdate";
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" minlength="10" maxlength="10" name="phone" class="form-control" placeholder="Your Phone *" value="<?php echo $arrdata['mobile'];?>" />
                  </div>

                  <div class="form-group">
                    <input type="text" name="refer" class="form-control" placeholder="Any reference" value="<?php echo $arrdata['refer'];?>" />
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="email" name="email" class="form-control" placeholder="Your Email *" value="<?php echo $arrdata['email'];?>" />
                  </div>
                  <div class="form-group">
